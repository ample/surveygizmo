...
describe Surveygizmo::API do
  ...
  describe "#contacts" do
    before do
     stub_get("/v1/survey/1018301/surveycampaign/673550/contact").
    ...
    it "requests the correct resource" do
      ...
      a_get("/v1/survey/1018301/surveycampaign/673550/contact").
