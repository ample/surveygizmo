...
describe Surveygizmo::API do
  ...
  describe "#survey_campaigns" do
    before do
     stub_get("/v1/survey/1018301/surveycampaign").
    ...
    it "requests the correct resource" do
      ...
      a_get("/v1/survey/1018301/surveycampaign").
  ...
  describe "#survey_campaign" do
    before do
     stub_get("/v1/survey/1018301/surveycampaign/673550").
    ...
    it "requests the correct resource" do
      ...
      a_get("/v1/survey/1018301/surveycampaign/673550").
        should have_been_made
    end
  end
end