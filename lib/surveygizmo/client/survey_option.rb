module Surveygizmo
  class Client
    ...
    module SurveyOption
      ...
      def survey_options(survey_id, survey_page, question_id, options={})
        get("survey/#{survey_id}/surveypage/#{survey_page}/surveyquestion/#{question_id}/surveyoption", options)
      end
      ...
      def survey_option(survey_id, survey_page, question_id, id, options={})
        get("survey/#{survey_id}/surveypage/#{survey_page}/surveyquestion/#{question_id}/surveyoption/#{id}", options)
      end
